  ...
  return (
    <Fragment>
      ...
      <Container maxWidth="lg">
        <main>
          <MainFeaturedPost classes={classes} />
          <SubFeaturedPost classes={classes} />
          ...
          <Grid container spacing={5} className={classes.mainGrid}>
            <Grid item xs={12} md={8}>
              ...
              >
                Written by <Link>Sarah White</Link> on 13 October, 2019
              </Typography>
              ...
              <Typography variant="subtitle1" gutterBottom>
                ...
                voluptatibus non commodi facilis autem nesciunt ad saepe quas
                aperiam ducimus assumenda consequuntur tempora necessitatibus
                est expedita voluptate, labore reiciendis id.
              </Typography>
              <Typography variant="subtitle1" gutterBottom>
                Lorem ipsum dolor sit amet consectetur adipisicing elit.
                Asperiores repudiandae nulla labore, nostrum quaerat nihil
                obcaecati esse vero soluta recusandae sunt non quis est quos
                explicabo incidunt. Accusantium, ut libero.
              </Typography>
